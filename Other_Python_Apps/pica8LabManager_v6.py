...
def LOGIN(username, password, loggedin, pica8apikey, runlabresetbutton, backupthelabbutton, goldenlabbackupbutton):
    payload = json.dumps({
        "username": username,
        "password": password
    })
    ...
    return username, password, loggedin, pica8apikey, runlabresetbutton, backupthelabbutton, goldenlabbackupbutton

def backupthelablocally(col2expander, username, password, loggedin, pica8apikey, tokenheaders, pica8apiurl, sgselector, allchecked, deviceschosen, switchgroup_devices, custombackup_tag, datetimestamp, sftp, deviceslist):
...
def labreset(col2expander, username, password, loggedin, pica8apikey, tokenheaders, pica8apiurl, sgselector, allchecked, deviceschosen, switchgroup_devices, custombackup_tag, datetimestamp, sftp, deviceslist):
...
def labbasicconfigreset(col2expander, username, password, loggedin, pica8apikey, tokenheaders, pica8apiurl, sgselector, allchecked, deviceschosen, switchgroup_devices, custombackup_tag, datetimestamp, sftp, deviceslist):
    col2expander.write ("Resetting Switches.....Please Standby.....")
    switchListing = {}
    configListing = {}
    if (deviceschosen):
...
def labrestore(col2expander, username, password, loggedin, pica8apikey, tokenheaders, pica8apiurl, sgselector, allchecked, deviceschosen, switchgroup_devices, custombackup_tag, customrestore_tag, dateselected, datetimestamp, sftp, deviceslist):
    col2expander.write ("Resetting Switches.....Please Standby.....")
...
username, password, loggedin, pica8apikey, runlabresetbutton, backupthelabbutton, goldenlabbackupbutton  = LOGIN(username, password, loggedin, pica8apikey, runlabresetbutton, backupthelabbutton, goldenlabbackupbutton)
print (loggedin)
...
if (loggedin == "success"):
    ...
    if ((backupthelablocallybutton and custombackup_tag) and (sgselector or dvselector or alldevices)):
        ...
        with st.spinner("Backing Up CURRENT Configs natively in AmpCon and to the /home/admin on AmpCon and on the Devices themselves! "):
                        ...
                        with col2expander:
                            backupthelablocally(col2expander, username, password, loggedin, pica8apikey, headers, pica8apiurl, sgselector, allchecked, deviceschosen, switchgroup_devices, custombackup_tag, datetimestamp, sftp, deviceslist)
    ...
    if runlabresetbutton:
        ...
        with st.spinner("Resetting LAB Devices to Centrally Routed EVPN DEMO Config, Standby..."):
                        ...
                        with col2expander:
                            labreset(col2expander, username, password, loggedin, pica8apikey, headers, pica8apiurl, sgselector, allchecked, deviceschosen, switchgroup_devices, custombackup_tag, datetimestamp, sftp, deviceslist)
    ...
    if runbasicconfigbutton:
        ...
        with st.spinner("Resetting LAB Devices to BASIC Config, Standby..."):
                        col2expander = col1.expander("LAB RESET Progress Viewer (Press the '+' to Monitor Progress) ")
                        with col2expander:
                           labbasicconfigreset(col2expander, username, password, loggedin, pica8apikey, headers, pica8apiurl, sgselector, allchecked, deviceschosen, switchgroup_devices, custombackup_tag, datetimestamp, sftp, deviceslist)
    ...
    if (( runlabrestorebutton and customrestore_tag) and (sgselector or dvselector or alldevices)):
        ...
        with st.spinner("Resetting LAB Devices to " + str(customrestore_tag) + " Config Standby..."):
                        col2expander = col1.expander("LAB RESET Progress Viewer (Press the '+' to Monitor Progress) ")
                        with col2expander:
                            labrestore(col2expander, username, password, loggedin, pica8apikey, headers, pica8apiurl, sgselector, allchecked, deviceschosen, switchgroup_devices, custombackup_tag, customrestore_tag, dateselected, datetimestamp, sftp, deviceslist)
